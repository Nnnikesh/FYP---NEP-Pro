...
const translations = {
  en: {
    ...
    // HomePage Hero
    hero_title: 'Visualize Your Perfect Event',
    hero_subtitle: 'Design traditional Nepali events in 3D with precision and cultural authenticity',
    get_started: 'Start Designing',
    view_marketplace: 'Browse Vendors',
    stat_assets: '3D Assets',
    stat_vendors: 'Vendors',
    stat_events: 'Events',
    live_3d_preview: 'Live 3D Preview',
    design_with_precision: 'Design with precision',

    // HomePage Features
    features_title: 'Why Choose NEP-Pro?',
    features_subtitle: 'Transform your traditional event planning with cutting-edge 3D technology',
    feature_1_title: '3D Visualization Engine',
    feature_1_desc: 'Design your event layout in immersive 3D with real cultural assets',
    feature_2_title: 'Technical Blueprints',
    feature_2_desc: 'Automatic generation of precise vendor specifications with XYZ coordinates',
    feature_3_title: 'NPR Budget Planning',
    feature_3_desc: 'Real-time cost estimation in Nepalese Rupees as you design',
    feature_4_title: 'Cultural Library',
    feature_4_desc: 'Authentic 3D models of Mandaps, Pooja setups, and traditional decor',

    // HomePage Cultural Section
    cultural_library_title: 'Cultural Decor Library',
    cultural_library_subtitle: 'Authentic 3D models for every traditional Nepali ceremony',
    mandaps: 'Mandaps',
    ...
    host_benefit_1: 'Visualize your event before spending a single rupee',
    host_benefit_2: 'Communicate exact requirements to vendors with technical blueprints',
    host_benefit_3: 'Budget planning with real-time NPR cost estimates',
    host_benefit_4: 'Ensure cultural authenticity with traditional decor options',
    vendor_benefit_1: 'Receive precise technical specifications with XYZ coordinates',
    vendor_benefit_2: 'Showcase your cultural specialization to targeted clients',
    vendor_benefit_3: 'Reduce miscommunication and ensure 100% execution accuracy',
    vendor_benefit_4: 'Digital presence for small businesses without technical skills',
    start_your_design: 'Start Your Design',
    join_marketplace: 'Join Marketplace',

    // HomePage CTA
    cta_title: 'Ready to Transform Your Event Planning?',
    cta_subtitle: 'Join hundreds of families and vendors already using NEP-Pro for perfect cultural celebrations',
    launch_designer: 'Launch 3D Designer',
  ...
  ne: {
    ...
    // HomePage Hero
    hero_title: 'आफ्नो उत्तम कार्यक्रम कल्पना गर्नुहोस्',
    hero_subtitle: 'परम्परागत नेपाली कार्यक्रमहरू ३डीमा सटीकता र सांस्कृतिक प्रामाणिकताका साथ डिजाइन गर्नुहोस्',
    get_started: 'डिजाइन सुरु गर्नुहोस्',
    view_marketplace: 'विक्रेताहरू हेर्नुहोस्',
    stat_assets: '३डी सम्पत्तिहरू',
    stat_vendors: 'विक्रेताहरू',
    stat_events: 'कार्यक्रमहरू',
    live_3d_preview: 'लाइभ ३डी पूर्वावलोकन',
    design_with_precision: 'सटीकताका साथ डिजाइन गर्नुहोस्',

    // HomePage Features
    features_title: 'NEP-Pro किन छान्ने?',
    features_subtitle: 'अत्याधुनिक ३डी प्रविधिसँग आफ्नो परम्परागत कार्यक्रम योजनालाई रूपान्तरण गर्नुहोस्',
    feature_1_title: '३डी दृश्य इन्जिन',
    feature_1_desc: 'वास्तविक सांस्कृतिक सम्पत्तिहरूसँग इमर्सिभ ३डीमा आफ्नो कार्यक्रम लेआउट डिजाइन गर्नुहोस्',
    feature_2_title: 'प्राविधिक योजनाहरू',
    feature_2_desc: 'XYZ निर्देशांकहरूसँग सटीक विक्रेता विशिष्टताहरूको स्वचालित उत्पादन',
    feature_3_title: 'NPR बजेट योजना',
    feature_3_desc: 'तपाईंले डिजाइन गर्दा नेपाली रुपैयाँमा वास्तविक-समय लागत अनुमान',
    feature_4_title: 'सांस्कृतिक पुस्तकालय',
    feature_4_desc: 'मण्डप, पूजा सेटअप, र परम्परागत सजावटका प्रामाणिक ३डी मोडेलहरू',

    // HomePage Cultural Section
    cultural_library_title: 'सांस्कृतिक सजावट पुस्तकालय',
    cultural_library_subtitle: 'प्रत्येक परम्परागत नेपाली समारोहका लागि प्रामाणिक ३डी मोडेलहरू',
    mandaps: 'मण्डपहरू',
    ...
    host_benefit_1: 'एक रुपैयाँ खर्च गर्नु अघि आफ्नो कार्यक्रम कल्पना गर्नुहोस्',
    host_benefit_2: 'प्राविधिक योजनाहरूसँग विक्रेताहरूलाई सटीक आवश्यकताहरू सञ्चार गर्नुहोस्',
    host_benefit_3: 'वास्तविक-समय NPR लागत अनुमानसँग बजेट योजना',
    host_benefit_4: 'परम्परागत सजावट विकल्पहरूसँग सांस्कृतिक प्रामाणिकता सुनिश्चित गर्नुहोस्',
    vendor_benefit_1: 'XYZ निर्देशांकहरूसँग सटीक प्राविधिक विशिष्टताहरू प्राप्त गर्नुहोस्',
    vendor_benefit_2: 'लक्षित ग्राहकहरूलाई आफ्नो सांस्कृतिक विशेषज्ञता प्रदर्शन गर्नुहोस्',
    vendor_benefit_3: 'गलत सञ्चार घटाउनुहोस् र १००% कार्यान्वयन सटीकता सुनिश्चित गर्नुहोस्',
    vendor_benefit_4: 'प्राविधिक सीप बिना साना व्यवसायहरूका लागि डिजिटल उपस्थिति',
    start_your_design: 'आफ्नो डिजाइन सुरु गर्नुहोस्',
    join_marketplace: 'बजारमा सामेल हुनुहोस्',

    // HomePage CTA
    cta_title: 'आफ्नो कार्यक्रम योजनालाई रूपान्तरण गर्न तयार हुनुहुन्छ?',
    cta_subtitle: 'सही सांस्कृतिक उत्सवहरूका लागि NEP-Pro प्रयोग गरिरहेका सयौं परिवार र विक्रेताहरूमा सामेल हुनुहोस्',
    launch_designer: '३डी डिजाइनर सुरु गर्नुहोस्',
