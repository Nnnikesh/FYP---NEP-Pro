...
const translations = {
  en: {
    ...
    mission_para_2: 'We\'re solving this by providing a dedicated event visualization platform specifically designed for Nepali cultural traditions. Hosts can browse real vendor portfolio photos, design their event setup interactively, and share the visual with vendors to align on the exact look and feel before the big day.',
    ...
    step_1_title: 'Browse Real Vendor Portfolios',
    step_1_desc: 'Explore verified vendor photos across categories — from Mandap decorators to caterers and florists — to find the right style and inspiration for your celebration',
    step_2_title: 'Design Your Event Interactively',
    step_2_desc: 'Place cultural decor elements in a 2D floor plan or 3D walkthrough to visualise your full event setup — Mandaps, Pooja arrangements, seating, and more — before committing to anything',
    step_3_title: 'Share the Vision with Your Vendor',
    step_3_desc: 'Send your event design directly to vendors so both sides are aligned on the layout, style, and decoration arrangement before the booking is confirmed',
    step_4_title: 'Book, Pay & Track in One Place',
    step_4_desc: 'Send an inquiry, confirm the booking, pay your deposit via eSewa or cash, and track every detail from your personal dashboard — all without leaving the platform',
    ...
    vendor_key_benefit_1: 'Receive clear visual layouts of the client\'s event setup',
    ...
    precision_desc: 'Visual clarity through interactive 2D and 3D design ensures hosts and vendors are perfectly aligned before the event',
  ...
  ne: {
    ...
    mission_para_1: 'नेपालको कार्यक्रम उद्योगले एक महत्वपूर्ण "दृश्यावलोकन संकट" सामना गर्दैछ — परिवारहरूले विक्रेताहरूलाई आफ्नो दृष्टिकोण सञ्चार गर्न संघर्ष गर्छन्, जसले निराशाजनक परिणाम र बर्बाद स्रोतहरू निम्त्याउँछ।',
    mission_para_2: 'हामी नेपाली सांस्कृतिक परम्पराहरूका लागि विशेष रूपमा डिजाइन गरिएको एक समर्पित कार्यक्रम दृश्यावलोकन प्लेटफर्म प्रदान गरेर यो समाधान गर्दैछौं। आयोजकहरूले वास्तविक विक्रेता पोर्टफोलियो फोटोहरू ब्राउज गर्न, आफ्नो कार्यक्रम सेटअप अन्तरक्रियात्मक रूपमा डिजाइन गर्न, र ठूलो दिन अघि सटीक रूप र भाव मिलाउन विक्रेताहरूसँग भिजुअल साझा गर्न सक्छन्।',
    ...
    step_1_title: 'वास्तविक विक्रेता पोर्टफोलियो ब्राउज गर्नुहोस्',
    step_1_desc: 'मण्डप सजावटकर्तादेखि खानपान र फूलफुलाई विशेषज्ञसम्म — आफ्नो उत्सवका लागि सही शैली र प्रेरणा खोज्न प्रमाणित विक्रेता फोटोहरू अन्वेषण गर्नुहोस्',
    step_2_title: 'आफ्नो कार्यक्रम अन्तरक्रियात्मक रूपमा डिजाइन गर्नुहोस्',
    step_2_desc: '२डी फ्लोर प्लान वा ३डी भ्रमणमा सांस्कृतिक सजावट तत्वहरू — मण्डप, पूजा व्यवस्था, आसन, र थप — राखेर आफ्नो कार्यक्रम सेटअप दृश्यावलोकन गर्नुहोस्',
    step_3_title: 'आफ्नो विक्रेतासँग दृष्टिकोण साझा गर्नुहोस्',
    step_3_desc: 'आफ्नो कार्यक्रम डिजाइन सिधै विक्रेताहरूलाई पठाउनुहोस् ताकि बुकिङ पुष्टि हुनु अघि दुवै पक्ष लेआउट, शैली, र सजावट व्यवस्थामा एकमत हुन्',
    step_4_title: 'बुक, भुक्तान र ट्र्याक एकै ठाउँमा',
    step_4_desc: 'सोधपुछ पठाउनुहोस्, बुकिङ पुष्टि गर्नुहोस्, eSewa वा नगदमा डिपोजिट तिर्नुहोस्, र आफ्नो ड्यासबोर्डबाट हरेक विवरण ट्र्याक गर्नुहोस् — प्लेटफर्म नछोडी',
    ...
    vendor_key_benefit_1: 'ग्राहकको कार्यक्रम सेटअपको स्पष्ट भिजुअल लेआउट प्राप्त गर्नुहोस्',
    ...
    precision_desc: 'अन्तरक्रियात्मक २डी र ३डी डिजाइनको माध्यमबाट दृश्य स्पष्टताले आयोजकहरू र विक्रेताहरूलाई कार्यक्रम अघि पूर्ण रूपमा मिलाउँछ',
