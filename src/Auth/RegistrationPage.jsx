...
export default function RegistrationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true)
    try {
      const body = { name: formData.name, email: formData.email, phone: formData.phone, password: formData.password, role }
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-end bg-cover bg-center bg-no-repeat py-8"
